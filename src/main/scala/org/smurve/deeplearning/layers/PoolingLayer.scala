...
/**
  ...
  */
class PoolingLayer ( val name: String, val stride: Int = 2, val poolWidth: Int = 2, val poolHeight: Int = 2,
                     val outputWidth: Int, val function: PoolingFunction = MAX_POOLING ) extends Layer {
